...
import RemovedSucessfully from '../assets/icons/task_alt_24dp_085F63_FILL0_wght400_GRAD0_opsz24.svg';
    ...
    <div className="bg-transparent py-16 px-4 flex flex-col items-center">
      ...
      <div className="w-95 bg-white p-0 rounded-4xl font-medium text-center border border-[#085F63] flex flex-col items-center">
        ...
        <div className="w-full px-[0px] md:px-0 mb-0">
          <h1 className="text-gray-500 mb-0 text-lg font-semibold overline overline-offset-20 mb-0 w-full text-center items-center">¡El contacto ha sido</h1>
        </div>
        <div className="w-full px-[0px] md:px-0 mb-0">
          <h1 className="text-gray-500 mb-0 text-lg font-semibold mb-0 w-full text-center items-center">eliminado exitosamente!</h1>
        </div>
        </div>
