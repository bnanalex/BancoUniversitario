    ...
    <div className="bg-transparent py-16 px-4 flex flex-col items-center">
      ...
      <div className="w-95 bg-white p-0 rounded-4xl font-medium text-center border border-[#085F63] flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mt-5">
            <img 
            src={Check} 
            alt="Usuario Registrado Exitosamente" 
            className="w-30 h-25"
        />    
        </div>
        ...
        <div className="w-full px-[0px] md:px-0 mb-0">
          <h1 className="text-gray-500 mb-0 text-lg font-semibold overline overline-offset-20 mb-0 w-full text-center items-center">¡Usuario registrado con</h1>
        </div>
        <div className="w-full px-[0px] md:px-0 mb-0">
          <h1 className="text-gray-500 mb-0 text-lg font-semibold mb-0 w-full text-center items-center">éxito!</h1>
        </div>
        </div>
            ...
            <div className="flex flex-grid items-center justify-center w-full md:max-w-[400px] gap-6">
                ...
                <div className="w-full">
                    <button className="w-54 bg-teal-800 hover:bg-teal-600 text-sm text-white font-semilight 
                    py-2 px-6 rounded-xl transition-colors duration-200">
                        Ir a la Banca en Linea
                    </button>
                </div>
            </div>
        </div>       
...
export default RegisteredSucess;