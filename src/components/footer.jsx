    ...
    <footer className="bg-teal-800 text-white py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-around items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <a href="https://x.com/home?lang=en" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start">
            <img src={twitterIcon} alt="Twitter-X" className="h-5 mr-1" />
            @bancouniversitariove
          </a>
        </div>
      </div>
